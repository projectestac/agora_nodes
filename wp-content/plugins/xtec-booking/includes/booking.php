...
function xtec_add_metabox_parameters_booking($post)
{
    ...
    if (!empty($data['parameters'])) {
        $data['parameters']['_xtec-booking-data'] = unserialize($data['parameters']['_xtec-booking-data'][0], ['allowed_classes' => false]);
    }
    ?>
            ...
            <td colspan="3" style="max-width:290px">
                <div class="xtec-booking-datetime">
                    ...
                    <input id="xtec-booking-start-date" name="_xtec-booking-start-date" type="text"
                           ...
                           value="<?php
                    echo (!empty($data['parameters']['_xtec-booking-data'])) ? $data['parameters']['_xtec-booking-data']['_xtec-booking-start-date'] : ''; ?>"
                           required>
            ...
            <td colspan="2" rowspan="2">
                <div class="xtec-booking-datetime">
                    ...
                    <input id="xtec-booking-start-time"
                           ...
                           value="<?php
                    echo (!empty($data['parameters']['_xtec-booking-data'])) ? $data['parameters']['_xtec-booking-data']['_xtec-booking-start-time'] : ''; ?>"
                           type="text" class="xtec-booking-input-datetime" required>
                </div>
                <div class="xtec-booking-datetime">
                    <span class="description"><?php _e('Finish time', 'xtec-booking'); ?></span>
                    <br>
                    <input id="xtec-booking-finish-time" name="_xtec-booking-finish-time" class="xtec-booking-input-time"
                           value="<?php
                           echo (!empty($data['parameters']['_xtec-booking-data'])) ? $data['parameters']['_xtec-booking-data']['_xtec-booking-finish-time'] : ''; ?>"
                           type="text" class="xtec-booking-input-datetime" <?php
                    if (isset($data['parameters']['_xtec-booking-data']) && $data['parameters']['_xtec-booking-data']['_xtec-booking-finish-time'] == '') { ?> disabled <?php
                    } ?> required>
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="3" style="max-width:290px">
                <div class="xtec-booking-datetime">
                    ...
                    <br>
                    <input id="xtec-booking-finish-date" name="_xtec-booking-finish-date" type="text"
                           class="xtec-booking-input-datetime" style="width:246px;margin-bottom: 4px;" value="<?php
                    echo (!empty($data['parameters']['_xtec-booking-data'])) ? $data['parameters']['_xtec-booking-data']['_xtec-booking-finish-date'] : ''; ?>" <?php
                    if (!empty($data['parameters']['_xtec-booking-data']) && $data['parameters']['_xtec-booking-data']['_xtec-booking-finish-date'] == ''){ ?>
                           disabled <?php
                           } ?>required><span id="xtec-booking-before-date-finish" class="style_message display_message_date"><?php
                        _e('Date before at actual date', 'xtec-booking'); ?></span>
                </div>
            </td>
        </tr>
        </tbody>
    ...
    <table class="form-table">
        ...
        <tr id="text_days"
            <?php
            if (empty($data['parameters']) || ($data['parameters']['_xtec-booking-data']['_xtec-booking-start-date'] == $data['parameters']['_xtec-booking-data']['_xtec-booking-finish-date'])) {
            ?>
        ...
        <tr id="xtec-booking-row-days" <?php
        if (empty($data['parameters']) || ($data['parameters']['_xtec-booking-data']['_xtec-booking-start-date'] == $data['parameters']['_xtec-booking-data']['_xtec-booking-finish-date'])) { ?> class="xtec-booking-display-none" <?php
        } ?> >
            <td>
                <input type="checkbox" name="_xtec-booking-day-monday" <?php
                if (isset($data['parameters']['_xtec-booking-data']['_xtec-booking-day-monday']) && $data['parameters']['_xtec-booking-data']['_xtec-booking-day-monday'] == 1) { ?> checked <?php
                } ?>>
                <span class="description xtec-non-italic"><?php
                    _e('Monday', 'xtec-booking'); ?></span>
            </td>
            <td>
                <input type="checkbox" name="_xtec-booking-day-tuesday" <?php
                if (isset($data['parameters']['_xtec-booking-data']['_xtec-booking-day-tuesday']) && $data['parameters']['_xtec-booking-data']['_xtec-booking-day-tuesday'] == 1) { ?> checked <?php
                } ?>>
                <span class="description xtec-non-italic"><?php
                    _e('Tuesday', 'xtec-booking'); ?></span>
            </td>
            <td>
                <input type="checkbox" name="_xtec-booking-day-wednesday" <?php
                if (isset($data['parameters']['_xtec-booking-data']['_xtec-booking-day-wednesday']) && $data['parameters']['_xtec-booking-data']['_xtec-booking-day-wednesday'] == 1) { ?> checked <?php
                } ?>>
                <span class="description xtec-non-italic"><?php
                    _e('Wednesday', 'xtec-booking'); ?></span>
            </td>
            <td>
                <input type="checkbox" name="_xtec-booking-day-thursday" <?php
                if (isset($data['parameters']['_xtec-booking-data']['_xtec-booking-day-thursday']) && $data['parameters']['_xtec-booking-data']['_xtec-booking-day-thursday'] == 1) { ?> checked <?php
                } ?>>
                <span class="description xtec-non-italic"><?php
                    _e('Thursday', 'xtec-booking'); ?></span>
            </td>
            <td>
                <input type="checkbox" name="_xtec-booking-day-friday" <?php
                if (isset($data['parameters']['_xtec-booking-data']['_xtec-booking-day-friday']) && $data['parameters']['_xtec-booking-data']['_xtec-booking-day-friday'] == 1) { ?> checked <?php
                } ?> >
                <span class="description xtec-non-italic"><?php
                    _e('Friday', 'xtec-booking'); ?></span>
            </td>
            <td>|</td>
            <td>
                <input type="checkbox" name="_xtec-booking-day-saturday" <?php
                if (isset($data['parameters']['_xtec-booking-data']['_xtec-booking-day-saturday']) && $data['parameters']['_xtec-booking-data']['_xtec-booking-day-saturday'] == 1) { ?> checked <?php
                } ?> >
                <span class="description xtec-non-italic"><?php
                    _e('Saturday', 'xtec-booking'); ?></span>
            </td>
            <td>
                <input type="checkbox" name="_xtec-booking-day-sunday" <?php
                if (isset($data['parameters']['_xtec-booking-data']['_xtec-booking-day-sunday']) && $data['parameters']['_xtec-booking-data']['_xtec-booking-day-sunday'] == 1) { ?> checked <?php
                } ?> >
                <span class="description xtec-non-italic"><?php
                    _e('Sunday', 'xtec-booking'); ?></span>
            </td>
        </tr>
