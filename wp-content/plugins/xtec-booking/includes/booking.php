			...
			<tr>
				<td colspan="3">
					<div class="xtec-booking-datetime">
						...
						<br>
						<input id="xtec-booking-start-date" name="_xtec-booking-start-date" type="text" class="xtec-booking-input-datetime" value="<?php echo $data['parameters']['_xtec-booking-data']['_xtec-booking-start-date']; ?>" required><br><span id="xtec-booking-before-date" class="style_message display_message_date"><?php _e('* Date before at actual date','xtec-booking'); ?></span>
					</div>
				</td>
			...
			<tr>
				<td colspan="3">
					<div class="xtec-booking-datetime">
						...
						<br>
						<input id="xtec-booking-finish-date" name="_xtec-booking-finish-date" type="text" class="xtec-booking-input-datetime" value="<?php echo $data['parameters']['_xtec-booking-data']['_xtec-booking-finish-date']; ?>" <?php if ( $data['parameters']['_xtec-booking-data']['_xtec-booking-finish-date'] == ''){ ?> disabled <?php } ?>required><br><span id="xtec-booking-before-date-finish" class="style_message display_message_date"><?php _e('* Date before at actual date','xtec-booking'); ?></span>
					</div>
				</td>
			</tr>
		</tbody>
