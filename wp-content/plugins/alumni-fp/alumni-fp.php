    ...
    if (current_user_can('activate_plugins')) {
        echo '
            <div style="text-align:center">
                <img height="150px" src="https://projectes.xtec.cat/impulsfp/wp-content/uploads/usu2078/2023/03/AlumniFP.png" alt="" />
            </div>
            <p>
            ...
            1. <a target="_blank" href="https://ja.cat/alumnifp-export">Descarregueu</a> el fitxer que conté les pàgines de l\'espai Alumni. És un fitxer amb extensió xml.<br /><br />
            2. <a target="_blank" href="admin.php?import=wordpress">Importeu</a> el fitxer descarregat marcant "Descarregar i importar adjunts". Es crearan un conjunt de pàgines relacionades amb Alumni FP.<br /><br />
            3. Afegiu la <a target="_blank" href="' . home_url() . '/lexalumnat-4/">pàgina inicial d\'Alumni</a> al menú del vostre web.
        ';
    }
}
