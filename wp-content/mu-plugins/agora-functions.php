...
function default_theme_mod(): array {
    ...
    $icons = array_filter($origin_icons, function($key) {
    ...
    return [
        'custom_logo' => isset($logo) ? $logo : 0,
        'pre_blog_name' => '',
        'postal_address' => isset($reactor_options['direccioCentre']) ? $reactor_options['direccioCentre'] : '',
        'postal_code_city' => isset($reactor_options['cpCentre']) ? $reactor_options['cpCentre'] : '',
        'phone_number' => isset($reactor_options['telCentre']) ? $reactor_options['telCentre'] : '',
        'link_to_map' => isset($reactor_options['googleMaps']) ? $reactor_options['googleMaps'] : '',
        'contact_page' => isset($reactor_options['emailCentre']) ? $reactor_options['emailCentre'] : '',
        'email_address' => '',
        'header_icon_1_classes' => isset($icons['icon1']) ? $icons['icon1'] : '',
        'header_icon_1_text' => isset($origin_icons['title_icon1']) ? $origin_icons['title_icon1'] : 'Icon # 1',
        'header_icon_1_link' => isset($origin_icons['link_icon1']) ? $origin_icons['link_icon1'] : '',
        'header_icon_1_open_in_new_tab' => true,
        'header_icon_2_classes' => isset($icons['icon2']) ? $icons['icon2'] : '',
        'header_icon_2_text' => isset($origin_icons['title_icon2']) ? $origin_icons['title_icon2'] : 'Icon # 2',
        'header_icon_2_link' => isset($origin_icons['link_icon2']) ? $origin_icons['link_icon2'] : '',
        'header_icon_2_open_in_new_tab' => true,
        'header_icon_3_classes' => '',
        'header_icon_3_text' => '',
        'header_icon_3_link' => '',
        'header_icon_3_open_in_new_tab' => true,
        'header_icon_4_classes' => isset($icons['icon4']) ? $icons['icon4'] : '',
        'header_icon_4_text' => isset($origin_icons['title_icon4']) ? $origin_icons['title_icon4'] : 'Icon # 4',
        'header_icon_4_link' => isset($origin_icons['link_icon4']) ? $origin_icons['link_icon4'] : '',
        'header_icon_4_open_in_new_tab' => true,
        'header_icon_5_classes' => isset($icons['icon5']) ? $icons['icon5'] : '',
        'header_icon_5_text' => isset($origin_icons['title_icon5']) ? $origin_icons['title_icon5'] : 'Icon # 5',
        'header_icon_5_link' => isset($origin_icons['link_icon5']) ? $origin_icons['link_icon5'] : '',
        ...
        'front_page_notice_pre_title' => 'Notice pre title',
        'front_page_notice_title' => 'Notice title',
        'front_page_notice_content' => 'Notice content...',
 ...
 *
 * @param string $new_theme Name of the theme that is being activated.
 * @return void
 */
function import_wigdets(string $new_theme = ''): void {
