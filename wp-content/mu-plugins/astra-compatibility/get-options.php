 ...
 *
 * @param $name string Option name in database
 * @param $default string a default value if option is available
 * @param $meta_id integer post meta id to retrieve meta from database
 * @package Reactor
 * @since 1.0.0
 * @author Anthony Wilhelm (@awshout / anthonywilhelm.com)
 * @license GNU General Public License v2 or later (http://www.gnu.org/licenses/gpl-2.0.html)
 */
function reactor_option(string $name, $default = false, $meta_id = null) {
    ...
    if (isset($meta_id)) {
        ...
        $meta = (get_post_meta($post_id, $meta_id, true)) ?: null;
        ...
        $options = (get_option('reactor_options')) ?: null;
    }
