...
function reactor_customizer_css() {
    ...
    if (0 === (int)reactor_option('show_title', 1)) {
    ...
    function reactor_customize_register($wp_customize) {
        ...
        class WP_Customize_Textarea_Control extends WP_Customize_Control {
            ...
            public function render_content() { ?>
                <label><span class="customize-control-title"><?php
        ...
        if (in_array('1c', $layouts[0])) {
            $theme_layouts['1c'] = __('One Column', 'reactor');
        }
        if (in_array('2c-l', $layouts[0])) {
            $theme_layouts['2c-l'] = __('Two Columns, Left', 'reactor');
        }
        if (in_array('2c-r', $layouts[0])) {
            $theme_layouts['2c-r'] = __('Two Columns, Right', 'reactor');
        }
        if (in_array('3c-l', $layouts[0])) {
            $theme_layouts['3c-l'] = __('Three Columns, Left', 'reactor');
        }
        if (in_array('3c-r', $layouts[0])) {
            $theme_layouts['3c-r'] = __('Three Columns, Right', 'reactor');
        }
        if (in_array('3c-c', $layouts[0])) {
            $theme_layouts['3c-c'] = __('Three Columns, Center', 'reactor');
        }
