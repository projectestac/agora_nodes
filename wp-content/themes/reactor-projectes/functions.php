 ...
 * @author Xavier Nieto (xnieto2@xtec.cat)
 * @version 1.1.0
 * @since 1.0.0
...
function xtec_projects_theme_scroll(){
    ...
    if( isset($projectes) && $projectes['logotipVisible'] === true ){
        wp_register_script( 'xtec-projectes-theme-js', get_theme_root_uri() . '/reactor-projectes/custom-tac/assets/js/project-theme.js', array('jquery'),'1.1', true );
        wp_enqueue_script( 'xtec-projectes-theme-js' );
    }
}

// Action to add js file
add_action('wp_head','xtec_projects_theme_scroll',10);
