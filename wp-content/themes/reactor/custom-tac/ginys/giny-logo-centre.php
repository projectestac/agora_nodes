    ...
    public function widget($args, $instance) {
        ...
        <div class="targeta_id_centre row">
            ...
            if (reactor_option('logo_image')) {
                ...
                ?>
                <div class="<?php reactor_columns([$amplada, 12]); echo ' ' . $class_logo; ?> hide-for-small">
                    <img alt="Logotip entitat" id="logo_entity" src="<?php echo reactor_option('logo_image'); ?>" />
                </div>
                <?php
            } else {
                $amplada = "12";
            ...
            ?>
            <div class="<?php reactor_columns($amplada);
            echo ' ' . $class_addr; ?> ">
                <div class="vcard">
