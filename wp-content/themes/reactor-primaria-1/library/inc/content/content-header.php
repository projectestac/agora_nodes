		...
		<div class="column">	
			<div id="idcentre-box" class="<?php reactor_columns(array( 3, 12 ));?>"> 
				...
				<!-- Primer bloc: text o logo -->
                                ...
                                <?php
                                    $description_text = get_description_text();
                                    $descriptionFontSize = get_description_font_size($description_text);
				  ?>
				  <!-- medium & large devices -->
				  <div id="description-box" class="hide-for-small site-description-box <?php reactor_columns( 6 ); ?> ">
				    <div  id="description-box-inner" style="font-size:<?php echo $descriptionFontSize;?>" class="site-description-box-inner">
                                        <div>
                                        <span><?php echo $description_text; ?></span>
                                        </div>
                                    </div>
                                </div>	
			</div><!-- #idcentre-box -->
